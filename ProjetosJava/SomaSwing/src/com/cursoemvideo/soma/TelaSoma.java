 ...
 * @author salve
 */
public class TelaSoma extends javax.swing.JDialog {

    /**
     * Creates new form TelaSoma
     */
    public TelaSoma(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaSoma dialog = new TelaSoma(new javax.swing.JFrame(), true);
